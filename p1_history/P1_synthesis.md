...
**Artifacts:** `P1_search_log.md`, `P1_screened.csv` (40 rows), `P1_useful.csv` (16 rows), `P1_quotes.md`  
...
| Not useful (N) | 9 |
| (Y+B+N) | 42 |
| Explicit counterexample useful rows | ≥2 (P1-017 high-serum maintenance; P1-018 serum-free infection medium) |
...
4. Pre-1940 vaccinia/yellow fever TC medium recipes (P1-025/026 borderline).  
